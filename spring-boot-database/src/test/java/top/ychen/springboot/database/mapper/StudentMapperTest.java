...
class StudentMapperTest {
    ...
    @Test
    void insert() {
        Student student = Student.builder().clazzId(1).studentName("测试学生test").hometown("江苏南京").birthday(LocalDate.now()).build();
    ...
    @Test
    void batchUpdate()  {
        List<Student> students = List.of(Student.builder().studentId(8003).studentName("新的名字").build()
                ,Student.builder().studentId(8004).studentName("新的名字").build()
                ,Student.builder().studentId(8005).studentName("新的名字").build());
