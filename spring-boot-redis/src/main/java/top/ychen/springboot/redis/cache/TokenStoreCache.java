package top.ychen.springboot.redis.cache;
...
import static top.ychen.springboot.redis.config.RedisCache.HOUR_SIX_EXPIRE;
...
public class TokenStoreCache {
    ...
    public void saveUser(String accessToken, UserLoginVO user){
        ...
        redisCache.set(userIdKey, accessToken, RedisCache.HOUR_SIX_EXPIRE);
        redisCache.set(accessTokenKey, user, RedisCache.HOUR_SIX_EXPIRE);
    }
