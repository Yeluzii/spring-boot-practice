package top.ychen.springboot.file.controller;
...
import top.ychen.springboot.file.utils.MinIoTemplate;
import top.ychen.springboot.file.utils.OssTemplate;
...
public class FileUploadController {
    ...
    public String minioUpload(MultipartFile file) {
        if (file != null) {
            ...
            try {
                url = minIoTemplate.putObject("ychen", "img/" + UUID.randomUUID() + suffixName, file.getInputStream());
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
            return url;
